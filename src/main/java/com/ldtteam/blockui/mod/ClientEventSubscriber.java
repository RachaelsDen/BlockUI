...
public class ClientEventSubscriber
{
    ...
    public static void onClientTickStart(final ClientTickEvent.Pre event)
    {
        ...
        if (modifiersDown)
        {
            ...
            else if (InputConstants.isKeyDown(minecraft.getWindow(), GLFW.GLFW_KEY_B))
            {
                openTestWindow(Identifier.fromNamespaceAndPath(BlockUI.MOD_ID, "gui/test3.xml"), BlockStateTestGui::setup);
            }
